...
```{r}
library(ggplot2)
ggplot(dataBFE,aes(x=hour2,y=HeartRate))+geom_smooth()+geom_point()+labs(x="Time of day (hours)", y="Heart Rate")
ggplot(dataBFE,aes(x=hour2,y=mood))+geom_smooth()+geom_point()+labs(x="Time of day (hours)", y="Negative/positive mood")
ggplot(dataBFE,aes(x=hour2,y=fresh))+geom_smooth()+geom_point()+labs(x="Time of day (hours)", y="Tired/fresh") + theme_bw() + theme(text = element_text(family = "Times New Roman", size=15), plot.title=element_text(size=21,face="bold"))
ggplot(dataBFE,aes(x=hour2,y=hunger))+geom_smooth()+geom_point()+labs(x="Time of day (hours)", y="Heart Rate")
...
lines(x=c(0,cos(pp)),y=c(0,sin(pp)),col='hotpink')
...
u2= cos(2*pi*cf*t)
#Plot the waves
plot(x=t,y=u, type='l',col='darkblue',xlab='Time of day (hours)',ylab='Amplitude')
...
ggplot(dataBFE, aes(x=hour2,y=sinCirc))+
      ...
      geom_point(aes(y=cosCirc),col='hotpink')+
...
plot(x=dataBFE$hour2,y=dataBFE$freshCircFit,type='p',col='hotpink', xlab="Time of day (hours)",ylab='Tired/Fresh')

ggplot(dataBFE,aes(x=hour2,y=fresh))+geom_smooth()+geom_line(aes(x=hour2,y=freshCircFit),col='hotpink')+labs(x='Time of day (hours)', y='Tired/Fresh') + theme_bw() + theme(text = element_text(family = "Times New Roman", size=15), plot.title=element_text(size=21,face="bold"))
```
...
ggplot(dataBFE, aes(x=hour2,y=sinCirc12))+
      geom_point(col='darkblue')+
      geom_point(aes(y=cosCirc12),col='hotpink')+
      ylab('sinCirc/cosCirc')+
      xlab("Time of day (hours)") + 
      theme_bw() + theme(text = element_text(family = "Times New Roman", size=15), plot.title=element_text(size=21,face="bold"))
...
plot(x=dataBFE$hour2,y=dataBFE$freshCircFit12,type='p',col='hotpink', xlab="Time of day (hours)",ylab='Tired/Fresh')

ggplot(dataBFE,aes(x=hour2,y=fresh))+geom_smooth()+geom_line(aes(x=hour2,y=freshCircFit12),col='hotpink')+labs(x='Time of day (hours)', y='Tired/Fresh') + theme_bw() + theme(text = element_text(family = "Times New Roman", size=15), plot.title=element_text(size=21,face="bold"))
```
...
plot(x=dataBFE$hour2,y=dataBFE$freshCircFitBoth,type='p',col='hotpink', xlab="Time of day (hours)",ylab='Tired/Fresh')

ggplot(dataBFE,aes(x=hour2,y=fresh))+geom_smooth()+geom_line(aes(x=hour2,y=freshCircFitBoth),col='hotpink')+labs(x='Time of day (hours)', y='Tired/Fresh') + theme_bw() + theme(text = element_text(family = "Times New Roman", size=15), plot.title=element_text(size=21,face="bold"))
```
...
ggplot(dataBFE,aes(x=Activity, fill = "hotpink"))+geom_bar()+coord_flip() + theme_bw() + theme(text = element_text(family = "Times New Roman", size=15), plot.title=element_text(size=21,face="bold"))
...
```{r}
library(ggplot2)
ggplot(dataBFE,aes(y=mood, x=as.factor(month)))+geom_boxplot()+labs(x="Month", y="Positive/Negative Mood")
...
# Demographics:
```{r}
dataBFE$Male <- dataBFE$Gender
dataBFE$Gender <- recode(dataBFE$Male, "male" = 1, "female" = 0)
genders <- na.omit(aggregate(dataBFE$Gender, list(dataBFE$id), FUN=mean))

ages <- na.omit(aggregate(dataBFE$age, list(dataBFE$id), FUN=mean))
